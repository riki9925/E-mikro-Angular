...
@Component({
  selector: 'app-pengkreditan-simpanan-form',
  templateUrl: './pengkreditan-simpanan-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PengkreditanSimpananFormComponent extends BaseComponent implements OnInit {
  @ViewChild('hasil_swal_sukses') hasil_swal_sukses;
  @ViewChild('hasil_swal_gagal') hasil_swal_gagal;
  jenis: JenisSimpanan;
  ...
  onChangeJenisRekening(item) {
    if (item.target.value !== '') {
      ...
      const payload = {
        BERITA: 'PENGKREDITAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
        KETERANGAN: 'PENGKREDITAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
      };
  ...
  posting() {
    ...
    this.service.postingSetoranSimpananAnggota(payload)
      .subscribe(r => {
