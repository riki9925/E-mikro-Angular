...
@Component({
  selector: 'app-simpanan-setoran-peranggota',
  templateUrl: './setoran-simpanan-peranggota.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SimpananSetoranPeranggotaComponent implements OnInit {
