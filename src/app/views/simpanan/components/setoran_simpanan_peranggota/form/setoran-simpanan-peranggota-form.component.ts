...
@Component({
  selector: 'app-simpanan-setoran-peranggota-form',
  templateUrl: './setoran-simpanan-peranggota-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SimpananSetoranPeranggotaFormComponent extends BaseComponent implements OnInit {
  jenis: JenisSimpanan;
  ...
  onChangeJenisRekening(item) {
    if (item.target.value !== '') {
      ...
      const payload = {
        BERITA: 'SETORAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
        KETERANGAN: 'SETORAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
      };
