...
@Component({
  selector: 'app-simpanan-master-approval',
  templateUrl: './simpanan-master-approval.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SimpananMasterApprovalComponent implements OnInit {
