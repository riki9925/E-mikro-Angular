...
@Component({
  selector: 'app-pendebetan-simpanan-form',
  templateUrl: './pendebetan-simpanan-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PendebetanSimpananFormComponent extends BaseComponent implements OnInit {
  jenis: JenisSimpanan;
  ...
  onChangeJenisRekening(item) {
    if (item.target.value !== '') {
      ...
      const payload = {
        BERITA: 'PENDEBETAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
        KETERANGAN: 'PENDEBETAN REK. SIMP A/N' + this.selectedAnggota.NAMA,
      };
  ...
  posting() {
    ...
    this.service.postingPendebetanSimpanan(payload)
      .subscribe(r => {
